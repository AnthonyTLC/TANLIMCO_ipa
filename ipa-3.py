...
def relationship_status(from_member, to_member, social_graph):
    ...
    #check the members' social graph or follow lists
    from_follows = social_graph [from_member] ["following"]
    to_follows = social_graph [to_member] ["following"]
    
    #check the relationship status of members
    if to_member in from_follows and from_member in to_follows:
        return "friends"
    elif to_member in from_follows and from_member not in to_follows:
        return "follower"
    elif from_member in to_follows and to_member not in from_follows:
        return "followed by"
    else:
...
def eta(first_stop, second_stop, route_map):
    ...
    #only count travel time until it reaches another distinct stop
