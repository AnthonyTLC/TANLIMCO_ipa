...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    remaining_material = total_material - used_material
    #need to have the output return a string
    remaining_material_str = f"{remaining_material}{material_units}"

    return remaining_material_str
